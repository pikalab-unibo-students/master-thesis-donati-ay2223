...
Each module manages a specific task in the infrastructure, such as installing and configuring a piece of software. \cite{puppetDocPlatform}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.8\linewidth]{figures/puppetplatform.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.8\linewidth]{figures/puppetagentserver.png}
