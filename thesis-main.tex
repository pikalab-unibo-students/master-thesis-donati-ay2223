...
%\begin{itemize}
%\item Install *nix agents
%\item Install Windows agents
%\begin{itemize}
%\item Install Windows agents with the .msi package
%\item Install Windows agents with the installer
%\item Install Windows agents using msiexec from the command line
%\begin{itemize}
%\item MSI properties
%\end{itemize}
%\item Upgrading or downgrading between 32-bit and 64-bit Puppet on Windows
%\begin{itemize}
%\item Upgrading to 64-bit
%\item Downgrading to 32-bit
%\end{itemize}
%\end{itemize}
%\item Install macOS agents
%\begin{itemize}
%\item Add full disk access for Puppet on macOS 10.14 and newer
%\item Install macOS agents from Finder
%\item Install macOS agents from the command line
%\item Install macOS agents with Homebrew
%\end{itemize}
