...
Some months before the acquisition there were big security issues related to Salt that is described at \url{https://news.hackreports.com/critical-saltstack-vulnerability-rce-exploit/}.
These issue were enough important to have two CVE-related, CVE-2020-11651 and CVE-2020-11652.
...
Also, there is a good community of more than 2000 contributors and also hundreds of businesses who use it.
...
That compatility table has also a detailed explanation which is available at \url{https://docs.saltproject.io/salt/install-guide/en/latest/topics/salt-supported-operating-systems.html}.
