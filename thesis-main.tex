...
\section{How the tool is shown to the community}
It is possible to see a starting point from the Chef community at \url{https://community.chef.io/}, the projects published by Chef are under Apache 2.0 license.
...
\textbf{Client}
Client(s), also called \textbf{Infra} or \textbf{Infra Client}, are usually called node(s). The machines where the code needs to execute.
Nodes pull the latest code from the Chef Server.
...
Automation are written in Ruby.
