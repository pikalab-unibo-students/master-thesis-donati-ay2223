...
An example on an automation tool could be Red Hat which offers Ansible Automation Platform.
...
In Chef, like others, it is possible to simply check the sintax with a single command via terminal.
