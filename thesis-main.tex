...
Integration test could be written on purpose to modify the system where they are running, and they are called \texttbf{destructive tests}\cite{saltDocTest}.
