...
Puppet is written in Ruby, which is not as simple as language for beginners like Python.
Puppet automation is not written in Ruby but in a Ruby DSL which adds another little difficulty to start with Puppet.
