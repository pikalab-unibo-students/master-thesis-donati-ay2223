...
\begin{abstract}
    ...
    Closed technology properties for example tools of Amazon, Google and Microsoft will not considered.
    The thesis analyzes for each technology the historical backgroud, the purpose of that, the community, the main components and some characteristics.
    Characteristics analyzed are platforms available, the project itself, the architecture and the extension. Also, it describes some information about the installation of the technology.
