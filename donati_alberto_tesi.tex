...
\begin{abstract}
    ...
    "Closed" technologies properties for example tools of Amazon, Google and Microsoft will not considered.
    ...
    There are present, at the end, some tables and explanations for a comparison point of view of the technologies analyzed.
    It then goes on to provide a summary overview of the reasons why professionals could choose one alternative over another.
\end{abstract}
...
Considering the last decades, the number of servers increase, computing capacity is increasing more and more and technologies grow.

So, now IT companies need also technologies to manage the infrastructure they have, which simplify and organize the jobs on servers.
...
These technologies are usually called "automation tools". Considering different DevOps technologies, this document aims to study and compare some open source technologies about automation.
